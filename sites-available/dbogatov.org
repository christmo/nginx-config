...
server {
    ...
    access_log /var/log/nginx/dbogatov.org.out.log;
    error_log /var/log/nginx/dbogatov.org.err.log;
    ...
    root /var/static/CV-Website/wwwroot;
    ...
    location = /404.html {
        root /var/static/CV-Website/wwwroot/errors/;
        internal;
    }
