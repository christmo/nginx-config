...
server {
    ...
    access_log /var/log/nginx/deploy.dbogatov.org.out.log;
    error_log /var/log/nginx/deploy.dbogatov.org.err.log;
            ...
            if data then
             ...
             if token == "SomeSecret" then
              ...
              elseif project == "MyBlog" then
               path = "/var/static/My-Blog/.deploy.sh"
              elseif project == "Inara-CV" then
               path = "/var/static/Inara-CV/.deploy.sh"
              end
